...
This example implements the drivers/libraries to handle the GPIO and the UART on the nanorv32-SoC system. The program does the same as the [4-uart_stub_2](../4-uart_stub_2/) example, but instead of using the uart function from the bootloader, it uses a library to configure the UART port.
...
1. Compile the program
    ```bash
    cd UPTC-Teaching/Computer-Architecture/2-RISC-V/hardware/riscv-soc-cores/sw/5-uart_puts
